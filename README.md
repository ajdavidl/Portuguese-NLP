...
- [BioBERTpt](https://huggingface.co/pucpr/biobertpt-all) - fine-tuned BERT models trained on the clinical domain for Portuguese language ([Github]([https://github.com/HAILab-PUCPR/gpt2-bio-pt](https://github.com/HAILab-PUCPR/BioBERTpt))).
